...
public final class PouchSlotAccessImpl {
    ...
    public static int getAccessoriesBeltSlotCount(Player player) {
        Container beltContainer = getAccessoriesBeltContainer(player);
    ...
    private static Object getAccessoriesCapability(LivingEntity entity) {
        ...
        try {
            ...
            Method getOptionallyMethod = capabilityClass.getMethod("getOptionally", LivingEntity.class);
            Object result = getOptionallyMethod.invoke(null, entity);
